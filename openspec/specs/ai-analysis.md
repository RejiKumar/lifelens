...
## 9. Requirements (ask-lifelens-v1)

Requirements added by the `ask-lifelens-v1` change. These SHALL govern whenever they conflict with historical prose in the Follow-Up Chat section and the follow-up endpoint subsections above.
